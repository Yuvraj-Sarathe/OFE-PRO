...
- **Live Preview** - Real-time preview with split-view, editor-only, or preview-only modes
- **Multiple Export Formats** - Export to HTML, Markdown, PDF, DOCX, and Plain Text
- **File Import** - Upload and parse TXT, HTML, MD, and DOCX files
- **Custom Modals** - Beautiful custom dialogs for links, images, videos, tables, and find/replace
- **Auto-Save** - Automatic local storage persistence
- **Responsive Design** - Works seamlessly on desktop and mobile devices
- **Modern UI** - Glassmorphism effects with emerald accent colors
